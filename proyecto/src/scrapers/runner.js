...
async function runScrapers() {
  ...
  const urlsTrackeadas = [
    { url: 'https://www.imperial.cl/cemento-melon-especial-saco-25kg-0103738/p', tienda: 'Imperial' },
  ...
  try {
    ...
    for (const termino of terminosDeBusqueda) {
      ...
      // Descubrir en Imperial
      const resultadosImp = await imperial.scrape(termino);
